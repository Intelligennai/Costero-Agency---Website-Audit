...
const PdfExportModalComponent: React.FC<PdfExportModalProps> = ({ isOpen, onClose, onGenerate, url, isGenerating }) => {
  ...
  return (
    ...
    >
        <div 
            className="w-full max-w-2xl flex flex-col bg-white dark:bg-brand-secondary rounded-xl shadow-2xl animate-slide-in"
        ...
        >
            <header className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-brand-accent">
                <div className="flex items-center gap-3">
                    ...
                    <h2 id="pdf-modal-heading" className="font-bold text-lg text-gray-900 dark:text-brand-text">Customize PDF Export</h2>
                </div>
            ...
            <main className="flex-1 p-6 space-y-6 overflow-y-auto max-h-[70vh]">
                <div>
                    <h3 className="font-semibold text-gray-700 dark:text-brand-light mb-3">Include Sections in PDF</h3>
                ...
                <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-brand-accent">
                    <h3 className="font-semibold text-gray-700 dark:text-brand-light">Branding Options</h3>
                    <div>
                        <label htmlFor="headerText" className="block text-sm font-medium text-gray-600 dark:text-brand-light mb-1">Header Text</label>
                        <input
                            id="headerText"
                            type="text"
                            value={headerText}
                     ...
                     <div>
                        <label htmlFor="footerText" className="block text-sm font-medium text-gray-600 dark:text-brand-light mb-1">Footer Text</label>
                        <input
                            id="footerText"
                            type="text"
                            value={footerText}
                    ...
                    <div className="flex items-center gap-4">
                       <div>
                          <label htmlFor="logoUpload" className="block text-sm font-medium text-gray-600 dark:text-brand-light mb-1">Company Logo (Optional)</label>
                           <input
                              id="logoUpload"
                              type="file"
